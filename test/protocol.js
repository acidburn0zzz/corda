...
tape('duplex', function (t) {
  ...
  var dup = Duplexer.obj(writable, readable)
...
tape('destroy', function (t) {
  ...
  var write = through()
  var read = through()
  var dup = new Duplexer(write, read)
...
tape('reset writable / readable', function (t) {
  ...
  var dup = new Duplexer(passthrough, passthrough)
...
tape('works with node native streams (net)', function (t) {
  ...
  var server = net.createServer(function (socket) {
    var dup = new Duplexer(socket, socket)
